...
MESSAGES = [
    "江湖路远，后会有期～以后的路就靠他自己走了，祝他前程似锦！",
    "天下没有不散的筵席，感谢这一路的陪伴，常回来看看哦～",
    "散伙饭看来是不用吃了，不过没关系，江湖再见亦是朋友！",
    "悄悄是别离的笙箫，愿他带着这里的回忆，去遇见更好的自己！",
    "走了也要记得我们呀～群里的大门永远敞开，随时欢迎回来唠嗑！",
    "人生就是不断相遇又告别，祝他接下来的旅途一路顺风、诸事皆宜！",
    "又少了一个并肩作战的队友，下次开黑就缺他了，祝好运！",
    "有缘自会再相逢，愿他往后的日子笑口常开，万事胜意～",
    "虽然离开了，但在这里的每一句玩笑和唠嗑都会记得，一路走好！",
    "挥手自兹去，萧萧班马鸣～走好不送，但欢迎随时回来！",
]
