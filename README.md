...
| 🎈 BTD6 情报站 | 气球塔防6活动查询 | Ninja Kiwi 官方开放数据：活动横幅总览、三类排行榜、规则详情（猴子立绘限制网格）、每日挑战（标准/高级/Coop）、远征 Odyssey（游戏内同款布局）、玩家档案、自制地图榜单、历史活动归档；活动刷新自动推送群聊，活动期间榜单卡定时预热，内容哈希缓存保证重复查询秒回，渲染失败自动回退纯文本 |
...
| `.btd6推送开启` / `.btd6推送关闭` | 活动刷新自动推送本群开关（仅主人；竞速/Boss/CT/远征/每日/Coop 刷新时推送更新图） |
